...
#
# Script generated by Vivado on Sat Jan 06 11:46:36 +0800 2024
...
#
# Usage        : mult_gen_0.sh
#                mult_gen_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_gen_0.sh [-reset_run]
#                mult_gen_0.sh [-reset_log]
#                mult_gen_0.sh [-help]
#
...
#                script (type 'mult_gen_0.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname xbip_pipe_v3_0_7 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mult_gen_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_gen_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mult_gen_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mult_gen_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mult_gen_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: mult_gen_0.sh [-step]\n\
Usage: mult_gen_0.sh [-lib_map_path]\n\
Usage: mult_gen_0.sh [-reset_run]\n\
Usage: mult_gen_0.sh [-reset_log]\n\
Usage: mult_gen_0.sh [-keep_index]\n\

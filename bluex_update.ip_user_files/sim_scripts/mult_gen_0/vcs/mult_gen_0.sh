...
design_libs=(xbip_utils_v3_0_11 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key mult_gen_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mult_gen_0_simv.daidir vcs_lib c.obj)

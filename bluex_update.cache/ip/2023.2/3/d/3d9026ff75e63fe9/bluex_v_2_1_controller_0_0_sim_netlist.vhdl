...
ID_EX_flush_INST_0_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
      I0 => IF_ID_stall_INST_0_i_2_n_0,
      I1 => ID_EX_flush_INST_0_i_6_n_0,
      I2 => ID_EX_flush_INST_0_i_7_n_0,
      I3 => ID_EX_flush_INST_0_i_4_n_0,
      O => ID_EX_flush_INST_0_i_3_n_0
    );
ID_EX_flush_INST_0_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      I0 => write_reg_addr_ex(0),
      I1 => write_reg_addr_ex(1),
      I2 => write_reg_addr_ex(4),
      I3 => write_reg_addr_ex(3),
      I4 => write_reg_addr_ex(2),
      O => ID_EX_flush_INST_0_i_4_n_0
    );
ID_EX_flush_INST_0_i_5: unisim.vcomponents.LUT6
    generic map(
...
ID_EX_flush_INST_0_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
IF_ID_flush_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
IF_ID_stall_INST_0: unisim.vcomponents.LUT6
    generic map(
      INIT => X"22F20000FFFFFFFF"
    )
        port map (
      I0 => ID_EX_flush_INST_0_i_1_n_0,
      I1 => ID_EX_flush_INST_0_i_2_n_0,
      I2 => IF_ID_stall_INST_0_i_1_n_0,
      I3 => IF_ID_stall_INST_0_i_2_n_0,
      I4 => mem_rd_ex,
      I5 => \^enable_cpu\,
      O => IF_ID_stall
    );
IF_ID_stall_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2002000000002002"
    )
        port map (
...
IF_ID_stall_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000013800000000"
    )
        port map (
      I0 => real_op(3),
      I1 => real_op(4),
...
\rs_forward[1]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
        ...
        port map (
      I0 => reg_write_ex,
      I1 => IF_ID_stall_INST_0_i_1_n_0,
      I2 => IF_ID_stall_INST_0_i_2_n_0,
      O => rs_forward(1)
    );

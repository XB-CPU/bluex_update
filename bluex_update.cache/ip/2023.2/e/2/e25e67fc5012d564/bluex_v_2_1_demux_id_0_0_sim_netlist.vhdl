...
\pc_next[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => enable_CPU,
      I1 => ena_n,
      O => \pc_next[15]_i_1_n_0\
    );
\pc_next_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => \pc_next[15]_i_1_n_0\,
      D => pc_next_inw(0),
      Q => pc_next(0),
      R => \^sr\(0)
    );
...
real_rst_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_INFO of real_rst : signal is "xilinx.com:signal:reset:1.0 real_rst RST";
  attribute X_INTERFACE_PARAMETER of real_rst : signal is "XIL_INTERFACENAME real_rst, POLARITY ACTIVE_HIGH, INSERT_VIP 0";

...
architecture STRUCTURE of bluex_v_2_1_BJT_0_0_BJT is
  ...
  signal \rt_rs_diff__10\ : STD_LOGIC;
  signal \rt_rs_diff_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__0_i_4_n_0\ : STD_LOGIC;
  ...
  signal \rt_rs_diff_carry__1_i_1_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__1_i_2_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \rt_rs_diff_carry__1_n_2\ : STD_LOGIC;
  signal \rt_rs_diff_carry__1_n_3\ : STD_LOGIC;
  signal rt_rs_diff_carry_i_1_n_0 : STD_LOGIC;
  signal rt_rs_diff_carry_i_2_n_0 : STD_LOGIC;
  signal rt_rs_diff_carry_i_3_n_0 : STD_LOGIC;
  signal rt_rs_diff_carry_i_4_n_0 : STD_LOGIC;
...
branch_jump_flag_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
rt_rs_diff_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => rt_rs_diff_carry_i_1_n_0,
      S(2) => rt_rs_diff_carry_i_2_n_0,
      S(1) => rt_rs_diff_carry_i_3_n_0,
      S(0) => rt_rs_diff_carry_i_4_n_0
    );
\rt_rs_diff_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \rt_rs_diff_carry__0_i_1_n_0\,
      S(2) => \rt_rs_diff_carry__0_i_2_n_0\,
      S(1) => \rt_rs_diff_carry__0_i_3_n_0\,
      S(0) => \rt_rs_diff_carry__0_i_4_n_0\
    );
\rt_rs_diff_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\rt_rs_diff_carry__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\rt_rs_diff_carry__0_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\rt_rs_diff_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\rt_rs_diff_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \rt_rs_diff_carry__1_i_1_n_0\,
      S(1) => \rt_rs_diff_carry__1_i_2_n_0\,
      S(0) => \rt_rs_diff_carry__1_i_3_n_0\
    );
\rt_rs_diff_carry__1_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\rt_rs_diff_carry__1_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\rt_rs_diff_carry__1_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
rt_rs_diff_carry_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
rt_rs_diff_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
inst: entity work.bluex_v_2_1_BJT_0_0_BJT
     port map (
      alu_op_ex(5 downto 0) => alu_op_ex(5 downto 0),
